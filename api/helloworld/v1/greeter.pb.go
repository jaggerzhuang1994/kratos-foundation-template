...
const file_helloworld_v1_greeter_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x18\x05R\x04name\"&\n" +
	"\n" +
	"HelloReply\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2i\n" +
	"\aGreeter\x12^\n" +
	"\bSayHello\x12\x1b.helloworld.v1.HelloRequest\x1a\x19.helloworld.v1.HelloReply\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/helloworld/{name}B\x80\x01\n" +
	"\x1cdev.kratos.api.helloworld.v1B\x11HelloworldProtoV1P\x01ZKgithub.com/jaggerzhuang1994/kratos-foundation-template/api/helloworld/v1;v1b\x06proto3"
